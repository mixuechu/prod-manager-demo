...
import { NotificationItem, NotificationType } from './NotificationContext';
...
export function Notification({ id, type, title, message, onClose }: NotificationProps) {
  return (
    <motion.div
      ...
      className={`max-w-sm w-full shadow-lg rounded-lg pointer-events-auto border ${notificationColors[type]}`}
    >
      <div className="p-4">
